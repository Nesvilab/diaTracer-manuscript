...
plasma_dia_try_pro_processed_miss = missing_summarize(plasma_dia_try_pro_processed, "FragPipe\n(tryptic)")
plasma_dia_semi_pro_processed_miss = missing_summarize(plasma_dia_semi_pro_processed, "FragPipe\n(semi-tryptic)")
...
plasma_num_pro_miss$id_portion = factor(plasma_num_pro_miss$id_portion, levels = c(">0%", ">25%", ">50%", "100%" ), ordered = TRUE)
plasma_num_pro_miss$method = factor(plasma_num_pro_miss$method, levels = c("FragPipe\n(tryptic)", "FragPipe\n(semi-tryptic)", "DIA-NN\nlib-free(tryptic)"), ordered = TRUE)
...
plasma_dia_try_pre_processed_miss = missing_summarize(plasma_dia_try_pre_processed, "FragPipe\n(tryptic)")
plasma_dia_semi_pre_processed_miss = missing_summarize(plasma_dia_semi_pre_processed, "FragPipe\n(semi-tryptic)")
plasma_num_pre_miss = 
...
plasma_num_pre_miss$id_portion = factor(plasma_num_pre_miss$id_portion, levels = c(">0%", ">25%", ">50%", "100%" ), ordered = TRUE)
plasma_num_pre_miss$method = factor(plasma_num_pre_miss$method, levels = c("FragPipe\n(tryptic)", "FragPipe\n(semi-tryptic)", "DIA-NN\nlib-free(tryptic)"), ordered = TRUE)
...
plasma_plot
ggsave("./figures/Figure4.pdf", plasma_plot, width=5.3, height = 4, units = c("in"), dpi=400)
