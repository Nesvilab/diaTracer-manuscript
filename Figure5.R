...
hla_method = c("Wahle et al.", "FragPipe")
...
spec_di_netmhcpan_pass$class="Spectronaut"
diaTracer_netmhcpan_pass$class="FragPipe"
...
length_dist_por$Method <- factor(length_dist_por$Method , levels=c("Spectronaut", "FragPipe", "Experimental DDA Library", "panlibrary"))
...
diaTracer_netmhcpan_pass$`FragPipe` = 1
...
bind_plot
ggsave("./figures/Figure5Part.pdf", bind_plot, width=5.3, height = 4, units = c("in"), dpi=400)
